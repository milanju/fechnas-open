...
<div id="login_form">
	...
	<input type="text" name="login_name" style="width: 80px;color:#787878 ;border:solid 1px #787878;" value="User Name" onFocus="value=''; this.style.color = 'black';">
	...
	<input type="submit" name="login_user" value="Login" style="color:black;">
