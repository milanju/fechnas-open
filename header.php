...
<body>
	<div id="wrapper">
		...
		<div id="content_body">
			<div id="above_header">
				...
				<div id="login_form">
					...
					<input type="text" name="login_name" class="login-input"
						style="width: 80px;color:#787878 ;border:solid 1px
						#787878;" value="User Name"
						onFocus="value=''; this.style.color = 'black';">
					<input type="password" name="login_pw" style="width: 80px;
						color:#787878 ;border:solid 1px #787878 ;"
						value="Password"
						onFocus="value=''; this.style.color = 'black';">
		...
		<div id="header">
			...
			$rnd_var = rand(1, 30);
			if ($rnd_var == 1) { ?>
				<a href="index.php"><img src="images/banner_k.png"
					width="1100" height="140"  alt="Home"></a>
			<?php } elseif ($rnd_var == 2) { ?>
				<a href="index.php"><img src="images/banner_kc.png"
					width="1100" height="140"  alt="Home"></a>
			<?php } elseif ($rnd_var == 3) { ?>
		 		<a href="index.php"><img src="images/banner.png"
		 			width="1100" height="140"  alt="Home"></a>
			<?php } else { ?>
				<a href="index.php"><img src="images/banner_c.png"
					width="1100" height="140"  alt="Home"></a>
			<?php } ?>
		</div>
		...
		<div id="navbar">
			<ul class="navbar_menu">
				<li class="navbar_menu"><a class="navbar_menu" href="index.php">
					Home
				</a></li>
				<li class="navbar_menu"><a class="navbar_menu" href="about.php">
					About
				</a></li>
			</ul>
		</div>
