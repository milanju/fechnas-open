...
<form action="" method="POST">
<input type="number" name="number_to_add" value="" class="bracketfield participant-number " style="width: 50px;">
<input type="submit" name="addTestParticipants" value="Add Test Participants" class="admin-button">
</form>
