<div id="stream_div" class="content-module">
  ...
  <button title="Click to show/hide Stream" class ="button" type="button"
                 ...
                 onclick="if(document.getElementById('spoiler')
                         ...
                         .style.display='none'}">Show/hide Stream
  </button>
  ...
  <div id="spoiler" style="display:none">
    <div id="stream">
      <object type="application/x-shockwave-flash" height="567" width="930"
                ...
                data="http://www.twitch.tv/widgets/live_embed_player.swf?channel=twitchplayspokemon"
                bgcolor="#000000"><param name="allowFullScreen"
